<script>
  ...
  function waitForQRLibrary(attempts = 0) {
    // Check both possible export names
    if (window.QRCode || window.qrcode) {
      ...
      console.error('QR library failed to load after 5 seconds. Window object:', Object.keys(window).filter(k => k.toLowerCase().includes('qr')));
    }
  }
...
<div class="app">
  <div class="container">
    <h1 class="title">🎨 Advanced QR Designer</h1>
    ...
    <button class="generate-button" on:click={regenerate}>
      Generate Designs
    </button>
    ...
    <div class="controls-grid">
      ...
      <div class="controls-section frame">
        <button class="section-header" on:click={() => frameControlsOpen = !frameControlsOpen}>
          <h2 class="controls-title">🖼️ Geometric Frame</h2>
    ...
    <div class="previews-section">
      ...
      <div class="previews-grid">
        ...
        <!-- Frame Preview -->
        <div class="preview-card">
          <h3 class="preview-title">Geometric Frame</h3>
          <div class="canvas-wrapper">
        ...
        <div class="preview-card full-width">
          <h3 class="preview-title">Combined QR Logo</h3>
          <div class="canvas-wrapper">
